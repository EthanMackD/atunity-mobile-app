      ...
      {conversations.length === 0 ? (
        ...
        conversations.map((conv) => (
          ...
          >
            ...
            {!conv.is_read && conv.receiver_id !== conv.other_user_id && (
...
const styles = StyleSheet.create({
  ...
  avatar: {
    width: 50, height: 50, borderRadius: 25, backgroundColor: '#065A82',
  ...
  convName: { fontSize: 16, fontWeight: 'bold', color: '#1E293B' },
